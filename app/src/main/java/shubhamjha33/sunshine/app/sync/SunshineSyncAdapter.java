package shubhamjha33.sunshine.app.sync;

/**
 * Created by Shubham on 07/04/2016.
 */
...
import shubhamjha33.sunshine.app.R;
import shubhamjha33.sunshine.app.Utility;
...
// 60 seconds (1 minute)*  180 = 3 hours
    public static final int SYNC_INTERVAL = 60000*180;
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(c.moveToFirst()){
            ...
            return ContentUris.parseId(mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, cv));
        }
    }
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            Log.d(LOG_TAG, "SunshineSyncAdapter Complete. " + cVVector.size() + " Inserted");
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter("APPID","c9785f722834467f06a96ad06c25ba38")
