package shubhamjha33.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Invalid Record",c,cv);
    ...
    public void testWeatherTable() {
        ...
        ContentValues cv=TestUtilities.createWeatherValues(TestUtilities.insertNorthPoleLocationValues(this.mContext));
        // Insert ContentValues into database and get a row ID back
        long row_id=db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, cv);
        assertNotSame(row_id,-1);
        // Query the database and receive a Cursor back
        // Move the cursor to a valid database row
